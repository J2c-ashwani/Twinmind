              ...
              children: [
                ...
                const StreakWidget(),
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          onPressed: () {
                            Navigator.pushNamed(context, '/growth-story');
                          },
                  ...
                  Expanded(
                        child: ElevatedButton.icon(
                          onPressed: () {
                            Navigator.pushNamed(context, '/twin-match');
                          },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildActionButton(
                        ...
                        backgroundColor: Colors.red.withOpacity(0.2), // Increased visibility
                        textColor: Colors.red[200], // Brighter text
                        iconColor: Colors.red[200], // Brighter icon
                      ),
                    ],
                  ),
                ),
